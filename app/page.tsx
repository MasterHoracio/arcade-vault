    ...
    <div className="home fade-in">
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            <button className="btn xl pulse" onClick={() => router.push("/juegos")}>▶  EXPLORAR JUEGOS</button>
      ...
      <section className="home-section reveal">
        ...
        <div style={{ textAlign: "center", marginTop: 24 }}>
          <button className="btn lg" onClick={() => router.push("/juegos")}>VER TODOS LOS JUEGOS →</button>
        </div>
      </section>
      ...
      <section className="home-final reveal">
        ...
        <button className="btn xl pulse final-cta" onClick={() => router.push("/juegos")}>INSERTAR MONEDA →</button>
