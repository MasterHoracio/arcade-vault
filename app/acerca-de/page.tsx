...
type FormState = "form" | "enviando" | "success" | "error";
          ...
          <form className={"contact-form" + (shake ? " shake" : "")} onSubmit={onSubmit}>
            {state === "form" || state === "enviando" ? (
              <>
                ...
                >
                  {state === "enviando" ? "ENVIANDO..." : "▶  ENVIAR MENSAJE"}
                </button>
              </>
            ) : state === "success" ? (
              ...
              <div className="terminal-error">
                ...
                <div className="term-body">
                  <div className="line"><span className="prompt">vault@arcade:~$</span> ./send_message --to=team</div>
                  <div className="line dim">[OK] Conectando con servidor…</div>
                  <div className="line dim">[FAIL] Transmitiendo paquete…</div>
                  <div className="line success">
